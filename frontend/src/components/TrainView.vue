<template>
  <div class="train-view">
    ...
    <p class="subtitle">
      Train YOLO detection models on your annotated shelf images. The active
      model is used by the Annotation Studio's detector.
    </p>

    <section class="card training-panel">
...
import { startTraining, getTrainingStatus,
...
<style scoped>
.train-view { max-width: 720px; margin: 0 auto; padding: 2rem; }
h2 { font-size: 1.4rem; margin-bottom: .35rem; color: #fff; }
.subtitle { font-size: .85rem; color: #777; margin-bottom: 1.5rem; }
